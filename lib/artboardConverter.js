...
function artboardConverter(document, artboard, artboardInfo) {
  ...
  function convertArtboardToSVG(imageRootObject) {
    ...
    artboardInfo.viewport.width ? svg.setAttribute('width', artboardInfo.viewport.width) : null;
    artboardInfo.viewport.height ? svg.setAttribute('height', artboardInfo.viewport.height) : null;
