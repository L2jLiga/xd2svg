...
function artboardConverter(document, artboard, artboardInfo) {
  ...
  function convertArtboardToSVG(imageRootObject) {
    ...
    title.innerHTML = artboardInfo.title;
    ...
    svg.setAttribute('viewBox', `${artboardInfo.x1} ${artboardInfo.y1} ${artboardInfo.x2} ${artboardInfo.y2}`);
    svg.setAttribute('width', artboardInfo.viewport.width);
    svg.setAttribute('height', artboardInfo.viewport.height);
