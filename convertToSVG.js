function generateSvgFromXD(artboardCollection) {
    'use strict';

    var svgImages = [];

    function createShape(pathObject) {
        var object = document.createElementNS('http://www.w3.org/2000/svg', pathObject.type);
    ...
    function createText(textObject) {
        ...
        var rawText = textObject.rawText
